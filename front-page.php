...
<div class="container-fluid px-0 ">
    ...
    <div class="row mx-0 bg-blue-1" style="min-height: 100vh;">
        <div class="container-fluid p-0 m-0">
            <div class="row pt-3 bg-blue-2">
                ...
                <div class="col-12 col-md-6">
                    <img class="img-fluid" src="<?php echo get_bloginfo('template_url') ?>/assets/images/womanandgirl.svg" alt="womanandgirl">
                </div>
            </div>
            <div class="row bg-blue-4 pt-3 mt-md-4 pt-md-5">
                ...
                <div class="col-12 col-md-6">
                    <div class="d-flex flex-row-reverse">
                        ...
                        <img class="img-fluid" src="<?php echo get_bloginfo('template_url') ?>/assets/images/hand-and-phone.svg" alt="">
                    </div>
                </div>
    ...
    <div class="row m-0 p-0 d-none d-md-flex" style="min-height: 100vh;">
        <div class="col-8 bg-blue-1">
            <div class="container-fluid ">
                <div class="row m-1 bg-blue-2">
                    <div class="col-5">
